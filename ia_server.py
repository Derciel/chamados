...
def generate_with_gemini(user_id, message):
    ...
    try:
        ...
        # Como este servidor não suporta streaming direto na resposta, vamos concatenar
        full_reply = "".join(chunk.text for chunk in response)
...
if __name__ == '__main__':
    # Este servidor rodará na porta 5000
